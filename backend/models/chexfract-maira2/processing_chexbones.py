...
class ChexBonesProcessor(ProcessorMixin):
    ...
    image_processor_class = "BitImageProcessor"
    slow_image_processor_class = "BitImageProcessor"
    fast_image_processor_class = "BitImageProcessor"
    ...
    def __call__(
        ...
        if images is not None:
            ...
            image_inputs = {"pixel_values": image_inputs['pixel_values'][:,None,...], 
                "image_sizes": torch.Tensor([518,518])[None,...].repeat(batch_size,1),
