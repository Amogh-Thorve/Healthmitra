...
CHEXBONES_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "AIRI/chexfract-maira2": "./config.json",
}


class ChexBonesConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`ChexBonesModel`]. It is used to instantiate a Phi-3
